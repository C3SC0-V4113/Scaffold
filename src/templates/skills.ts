...
3. Use Purrfold-installed Next.js workflow skills in \`.agents/skills/\` for Cache Components and dev-loop work when present; rerun \`./skills.sh\` if they are missing.
